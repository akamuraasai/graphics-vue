<template>
  <div class="home">
    ...
    <b-table id='mainTable' striped hover show-empty
             ...
             :empty-text="'Nenhum gráfico registrado'"
             :empty-filtered-text="'Nenhum gráfico registrado contem o texto digitado na busca'"
             @filtered="onFiltered"
    >
      ...
      <template slot="actions" scope="row">
        ...
        <b-btn size="sm" :variant="'success'" :href="`#/view/${row.item.id}/consultor_id=1070`"><i class="fa fa-eye"></i></b-btn>
        <b-btn size="sm" :variant="'warning'" :href="`#/edit/${row.item.id}/consultor_id=1070`"><i class="fa fa-pencil"></i></b-btn>
    ...
    <div class="row">
      ...
      <div class="col-sm-4 text-md-right">
        <b-button :variant="'success'" @click="$router.push('/edit')">Novo Gráfico</b-button>
      </div>
    </div>
...
export default {
  ...
  data: () => ({
    ...
    fields: {
      ...
      name: { label: 'Nome do Gráfico', sortable: true, 'class': 'text-center' },
